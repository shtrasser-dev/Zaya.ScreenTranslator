...
**1.0.1** — Primitives compatibility channel `1.0`. See [versioning](docs/versioning.md).

Host release tags: `app-v1.0.1` / `app-v1.0-latest`. Plugin update channel: `plugin-v1.0-latest`.
